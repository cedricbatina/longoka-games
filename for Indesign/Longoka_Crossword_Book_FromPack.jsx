...
(function () {
    ...
    function addTitlePage(doc, pack) {
        ...
        var eyebrow = addFrame(page, LG.pageBox(page, 37, 22, 44, 90), "Cahier premium de mots croises", LG.STYLES.p.bookSubtitle);
        ...
        var title = addFrame(page, LG.pageBox(page, 58, 22, 92, 92), compactTitle(LG.bookTitleFromPack(pack) || "Mots croises"), LG.STYLES.p.bookTitle);
    ...
    function addInstructionsPage(doc, pack) {
        ...
        addFrame(page, LG.pageBox(page, 38, 22, 51, 132), "Le rendu doit rester sobre mais ferme: une grille lisible, des indices nets et une correction rapide en fin d'ouvrage.", LG.STYLES.p.body);
        drawStepCard(page, LG.pageBox(page, 58, 22, 98, 132), "1. Lire", "Lis les indices et repere les entrees courtes avant les longues.", LG.SWATCHES.longokaPanel);
        drawStepCard(page, LG.pageBox(page, 104, 22, 144, 132), "2. Croiser", "Utilise les lettres deja trouvees pour debloquer les autres mots.", LG.SWATCHES.longokaPanel);
    ...
    function renderPuzzlePage(doc, page, puzzle, puzzleNumber) {
        addFrame(page, LG.pageBox(page, 19, 20, 28, 132), "Grille " + pad2(puzzleNumber) + "  |  " + compactTitle(puzzle.title || pack.title || "Mots croises"), LG.STYLES.p.puzzleTitle);
        ...
        renderCrosswordGrid(doc, page, puzzle, LG.pageBox(page, 52, 24, 112, 84), false);
        ...
        addFrame(page, LG.pageBox(page, 127, 26, 134, 76), "Horizontaux", LG.STYLES.p.wordListHeading);
        addFrame(page, LG.pageBox(page, 127, 82, 134, 126), "Verticaux", LG.STYLES.p.wordListHeading);
        addFrame(page, LG.pageBox(page, 136, 26, 198, 76), buildClueList(puzzle.entries || [], "ACROSS", pack), LG.STYLES.p.wordList);
        addFrame(page, LG.pageBox(page, 136, 82, 198, 126), buildClueList(puzzle.entries || [], "DOWN", pack), LG.STYLES.p.wordList);
    }
