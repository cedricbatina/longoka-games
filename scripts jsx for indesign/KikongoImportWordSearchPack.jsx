...
(function () {
  ...
  if (autonomousBundle.exists) {
    var bundledEntry = File(autonomousBundle.fsName + "/Longoka_WordSearch_Book_FromPack.jsx");
  ...
  var entry = File(forIndesignFolder.fsName + "/Longoka_WordSearch_Book_FromPack.jsx");
  if (!entry.exists) {
