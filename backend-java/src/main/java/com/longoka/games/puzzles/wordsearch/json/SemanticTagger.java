...
public final class SemanticTagger {
 ...
 public static List<String> guessTags(String frTranslation) {
  ...
  if (containsAny(text, "tête", "cerveau", "main", "ventre", "estomac", "vésicule", "rein", "foie", "poumons", "doigt",
    "dent", "langue", "koto", "cou", "muscle", "veine", "cheveux", "lèvre", "pénis", "sexe féminin",
