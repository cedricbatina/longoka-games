 ...
 * Kikongo (verbes) à partir de la base Lexikongo.
 */
public final class KikongoVerbCrosswordJsonExportTool {

  private KikongoVerbCrosswordJsonExportTool() {
    // utilitaire
  }

  public static void main(String[] args) throws Exception {
    System.out.println("== Export JSON : Mots croisés Kikongo (verbes) ==");

    int puzzleCount = 48; // nombre de grilles
    int rows = 12;
    int cols = 12;
    int maxEntries = 12; // mots par grille
    String meaningLanguageCode = "fr";
    String languageCode = "kg";
    String outputPath = "target/kikongo-verbs-crossword-book.v3.json";
    ...
    pack.packId = "kg-cross-verbs-" + LocalDate.now();
    pack.title = "Kikongo – mots croisés (verbes)";
    pack.description = "Pack généré automatiquement : " + puzzleCount + " grilles " + rows + "x" + cols + ".";
    ...
    System.out.println("✅ Export JSON (mots croisés verbes) terminé : " + out.toAbsolutePath());
  }
}
