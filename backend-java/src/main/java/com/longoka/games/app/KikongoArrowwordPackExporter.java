...
import com.longoka.games.lexikongo.KikongoArrowwordService;
...
/**
 * Exporteur réutilisable de packs JSON de mots fléchés Kikongo.
 *
 * Il centralise le format, la validation et la sérialisation afin d'éviter
 * de dupliquer la logique dans chaque tool CLI.
 */
public final class KikongoArrowwordPackExporter {

  private KikongoArrowwordPackExporter() {
    // utilitaire
  }
  ...
  public static void exportPack(
    ...
    KikongoArrowwordService service = new KikongoArrowwordService();
    ...
    System.out.println("✅ Export JSON (mots fléchés) terminé : " + out.toAbsolutePath());
  }
}
