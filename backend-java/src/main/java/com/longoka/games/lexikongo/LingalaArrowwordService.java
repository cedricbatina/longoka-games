...
/**
 * Générateur de mots fléchés Lingala basé sur le moteur crossword existant.
 */
public final class LingalaArrowwordService {

  private final LingalaCrosswordService crosswordService = new LingalaCrosswordService();
  ...
  public ArrowwordJsonModels.PuzzleV1 generateArrowword(
    ...
    meta.put("generator", "LingalaArrowwordService");
